...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 en_US no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 zh_TW no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 zh_CN no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 ja no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 de no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 fr no-branding release public
...
##############################################################################################
#$MozBuilder fx ${BUILD_ID} p0 en_US branding release private
#$MozBuilder fx ${BUILD_ID} p1 en_US branding release private
#$MozBuilder fx ${BUILD_ID} p2 en_US branding release private
#$MozBuilder fx ${BUILD_ID} p3 en_US branding release private
